...
> **⚠️ NON-AUTHORITATIVE** — This file is a snapshot/reference document. It does not define system truth.
> For canonical authority, see [`docs/governance/authority-hierarchy.md`](../governance/authority-hierarchy.md).
